...
#data_excl <- data %>%
  #filter(attentioncheck == "3")
#data_excl

###create aggregate cynicism score
#data_excl$cyn_total <- (data_excl(cyn1) + data_excl(cyn2) + data_excl(cyn3) + data_excl(cyn4) + data_excl(cyn5) + 
  #data_excl(cyn6) + data_excl(cyn7) + data_excl(cyn8) + data_excl(cyn9))/9
