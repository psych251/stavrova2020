...
testdata_anonymized <- subset(testdata, select = -c(1:4, 8:9, 14:16))
write.csv(testdata_anonymized, "/Users/ericneumann/Desktop/stavrova2020/writeup/testdata_anonymized.csv")
```
